...
export default function ContactPage() {
  return (
    <main id="top">
      <SiteHeader />
      <PageHero eyebrow="Start a conversation" title={<>Tell us what matters.<br /><span>We will take it from there.</span></>} description="Whether you need a better IT partner, help with a specific initiative or a clearer view of your current environment, you will speak with someone who understands both the business and technical context." primaryLabel="Call 242-601-6014" primaryHref="tel:+12426016014" secondaryLabel="Visit our office" secondaryHref="#location" />
