...
export default function CapabilitiesPage() {
  return (
    <main id="top">
      <SiteHeader />
      <PageHero eyebrow="Projects, expertise and added capacity" title={<>Build what is next.<br /><span>Improve what exists.</span></>} description="Engage Redstone for a focused initiative or to strengthen an established IT team with specialist expertise, engineering capacity, project delivery and independent guidance." primaryLabel="Plan your next technology move" secondaryLabel="See how we work" secondaryHref="#process" />
