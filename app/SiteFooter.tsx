    ...
    <footer className="site-footer">
      <div className="footer-main section-shell">
        ...
        <div className="footer-links">
          ...
          <div><h3>Capabilities</h3><a href="/capabilities">Ad Hoc Projects</a><a href="/capabilities">Security & Compliance</a><a href="/capabilities">AI Web & Applications</a><a href="/capabilities">Workflow Automation</a><Link href="/insights">Insights</Link></div>
