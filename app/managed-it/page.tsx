...
import { ArrowRight, Buildings, Compass, FlowArrow, Gauge, Headset, ShieldCheck, UsersThree } from "@phosphor-icons/react/dist/ssr";
      ...
      <section className="coverage-section section-pad" aria-labelledby="coverage-title">
        <div className="section-shell">
          ...
          <div className="service-models" id="partnership-models" aria-labelledby="service-models-title">
            <div className="service-models-intro">
              <p className="eyebrow">One partner. Two ways to work.</p>
              <h2 id="service-models-title">Your technology department—or an extension of it.</h2>
              <p>Redstone can take responsibility for your complete environment or work side by side with the internal team already leading it.</p>
            </div>
            <article>
              <Buildings size={30} weight="light" aria-hidden="true" />
              <span>01 / Fully Managed IT</span>
              <h3>Complete technology responsibility.</h3>
              <p>For organisations without an internal IT function, Redstone becomes the professionally managed technology department—providing standards, planning, support, security, projects, vendor coordination and ongoing accountability.</p>
              <a className="text-link" href="/contact">Explore fully managed IT <ArrowRight size={17} weight="bold" aria-hidden="true" /></a>
            </article>
            <article>
              <UsersThree size={30} weight="light" aria-hidden="true" />
              <span>02 / Co-Managed IT</span>
              <h3>More capability for your existing team.</h3>
              <p>Your internal team keeps its relationships and institutional knowledge while Redstone adds specialist expertise, tools, engineering capacity, projects, escalation support and coverage where defined gaps exist.</p>
              <a className="text-link" href="/contact">Strengthen your internal IT team <ArrowRight size={17} weight="bold" aria-hidden="true" /></a>
            </article>
          </div>
        </div>
      </section>
