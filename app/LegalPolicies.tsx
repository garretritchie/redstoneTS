...
function PrivacyPolicy() {
  return (
    <>
      ...
      <section><h3>10. Contact us</h3><p>For privacy questions or requests, use our <a href="/contact">website contact form</a>, email msp@redstoneTS.com, call <a href="tel:+12426016014">(242) 601-6014</a>, or write to 1st Floor, Church St. Building, Shirley Street, New Providence, The Bahamas.</p></section>
    </>
  );
}
...
function TermsOfUse() {
  return (
    <>
      ...
      <section><h3>10. Changes and contact</h3><p>We may update these terms from time to time. Continued website use after an updated version is posted means the revised terms apply from their stated effective date.</p><p>Questions may be sent through our <a href="/contact">website contact form</a>, by email to msp@redstoneTS.com, or to Redstone Technology Solutions Ltd., 1st Floor, Church St. Building, Shirley Street, New Providence, The Bahamas.</p></section>
    </>
  );
}
...
function CookiePolicy() {
  return (
    <>
      ...
      <section><h3>6. Contact</h3><p>Questions about website cookies may be sent through our <a href="/contact">website contact form</a>, by email to msp@redstoneTS.com, or raised by calling <a href="tel:+12426016014">(242) 601-6014</a>.</p></section>
    </>
  );
}
      ...
      <dialog className="legal-dialog" ref={dialogRef} aria-labelledby="legal-policy-title">
        <div className="legal-dialog-shell">
          ...
          <div className="legal-dialog-content" ref={contentRef}>
            ...
            <footer className="legal-document-footer"><strong>Questions about these policies?</strong><p>Use our <a href="/contact">contact form</a>, email msp@redstoneTS.com or call <a href="tel:+12426016014">(242) 601-6014</a>.</p></footer>
          </div>
        </div>
      </dialog>
    </>
