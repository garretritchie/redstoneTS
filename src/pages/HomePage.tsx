...
import { ArrowRight, ArrowUpRight, Brain, Briefcase, ChartLineUp, CheckCircle, CloudArrowUp, FlowArrow, GearSix, Headset, Lightning, Pulse, SealCheck, ShieldCheck, Sparkle, UsersThree } from "@phosphor-icons/react";
...
export default function HomePage() {
  ...
  return (
    <main id="top">
      <Helmet>
        <title>Managed IT Services Bahamas | Redstone Technology Solutions</title>
        <meta name="description" content="Managed IT services in The Bahamas, including cybersecurity, cloud, helpdesk, infrastructure support, monitoring and technology strategy for businesses." />
        <link rel="canonical" href="https://www.redstonets.com/" />
      </Helmet>
      ...
      <section className="home-insights section-pad" aria-labelledby="home-insights-title">
        <div className="section-shell">
          <div className="home-section-heading">
            ...
            <div><p>Ideas for owners, executives and IT leaders who want technology managed with more clarity, security and business discipline.</p><Link className="text-link" to="/insights">Explore our insights <ArrowRight size={17} weight="bold" aria-hidden="true" /></Link></div>
          </div>
